...
create table title_basics (tconst text,
                           titleType text,
                           primaryTitle text,
                           originalTitle text,
                           isAdult boolean,
...
create table temp_title_episode ( tconst text,
                                  parentTconst text,
                                  seasonNumber text,
                                  episodeNumber text );
...
create table title_episode ( tconst text,
                             parentTconst text,
...
create table temp_title_principals ( tconst text,
                                     ordering integer,
                                     nconst text,
                                     category text,
                                     job text,
...
create table title_principals ( tconst text,
                                ordering integer,
                                nconst text,
                                category text,
                                job text,
